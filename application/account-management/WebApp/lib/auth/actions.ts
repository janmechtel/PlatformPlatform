...
export const userInfoScheme = z.object({
  ...
  locale: z.string(),
  tenantId: tenantInfoScheme,
  userRole: userRoleScheme,
  userName: z.string(),
});
export type UserInfo = z.infer<typeof userInfoScheme>;

export const initialUserInfo: UserInfo | null = import.meta.runtime_env.IS_USER_AUTHENTICATED === "false"
  ? null
  : {
      email: import.meta.runtime_env.USER_EMAIL,
      locale: import.meta.runtime_env.LOCALE,
      tenantId: { value: import.meta.runtime_env.TENANT_ID },
      userRole: import.meta.runtime_env.USER_ROLE as UserRole,
      userName: import.meta.runtime_env.USER_NAME,
    };
...
export async function getUserInfo() {
  ...
  return userInfoScheme.parse(data);
}
